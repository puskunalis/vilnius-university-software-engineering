...
class DemoWebShopTest(unittest.TestCase):
    ...
    def test_demo_web_shop(self):
        ...
        driver.find_element(
            By.CLASS_NAME, "block-category-navigation").find_element(By.LINK_TEXT, "Computers").click()
        driver.find_element(
            By.CLASS_NAME, "block-category-navigation").find_element(By.LINK_TEXT, "Desktops").click()

        driver.find_element(
            By.XPATH, "//span[contains(@class,'price') and text()>1500]/parent::div/following-sibling::div[@class='buttons']/input[@value='Add to cart']").click()
        ...
        driver.find_element(
            By.XPATH, "//input[@type='checkbox' and @name='removefromcart']").click()
